  ...
  const renderParticipationCertificate = () => (
    <div className="certificate-preview with-background">
      <div className="certificate-header">
        <img src="/mdcan_logo.png" alt="MDCAN Logo" className="logo-image-preview" />
        ...
        <img src="/coal_city_logo.png" alt="Coal City Logo" className="logo-image-preview" />
      </div>
      ...
      <div className="signatures">
        ...
        <div className="signature">
          <img src="/chairman-signature.png" alt="Chairman Signature" className="signature-image-preview" />
          <div className="signature-name-preview">
  ...
  const renderServiceCertificate = () => (
    <div className="certificate-preview with-background">
      ...
      <div className="signatures">
        ...
        <div className="signature">
          <img src="/secretary-signature.png" alt="Secretary Signature" className="signature-image-preview" />
          <div className="signature-name-preview">
            Dr. Augustine Duru
          </div>
          <div className="signature-title-preview">
